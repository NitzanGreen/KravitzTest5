...
function sumFunc() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementById("sum1_Q").innerText = data.project.projectGame[0].games[0].Qest;
            document.getElementById("sum1_ANS").innerText = data.project.projectGame[0].games[0].ans2[0];

            document.getElementById("T_F2").innerText = fruits[1];
            document.getElementById("sum2_Q").innerText = data.project.projectGame[0].games[1].Qest;
            document.getElementById("sum2_ANS").innerText = data.project.projectGame[0].games[1].ans1[0];

            document.getElementById("T_F3").innerText = fruits[2];
            document.getElementById("sum3_Q").innerText = data.project.projectGame[0].games[2].Qest;
            document.getElementById("sum3_ANS").innerText = data.project.projectGame[0].games[2].ans3[0];

            document.getElementById("T_F4").innerText = fruits[3];
            document.getElementById("sum4_Q").innerText = data.project.projectGame[0].games[3].Qest;
            document.getElementById("sum4_ANS").innerText = data.project.projectGame[0].games[3].ans1[0];
        }
        });
}
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            myTxt = function () {
                ...
                document.getElementById("G1_Q1").innerText = data.project.projectGame[0].games[counter_G1 - 1].Qest;
                document.getElementById("G1_Q1_Ans1").innerText = data.project.projectGame[0].games[counter_G1 - 1].ans1[0];
                document.getElementById("G1_Q1_Ans2").innerText = data.project.projectGame[0].games[counter_G1 - 1].ans2[0];
                document.getElementById("G1_Q1_Ans3").innerText = data.project.projectGame[0].games[counter_G1 - 1].ans3[0];
            }
            myTxt();
